...
/* harmony import */ var _modules_consult_button_content__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/consult-button-content */ "./js/modules/consult-button-content.js");
/* harmony import */ var _modules_consult_button_content__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_consult_button_content__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _modules_toggle_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/toggle-button */ "./js/modules/toggle-button.js");
/* harmony import */ var _modules_toggle_button__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_toggle_button__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_goods_services_subtitle_content__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/goods-services-subtitle-content */ "./js/modules/goods-services-subtitle-content.js");
/* harmony import */ var _modules_goods_services_subtitle_content__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_goods_services_subtitle_content__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _modules_modal_open_close__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modal-open-close */ "./js/modules/modal-open-close.js");
/* harmony import */ var _modules_modal_open_close__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_modal_open_close__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _modules_footer_accordion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/footer-accordion */ "./js/modules/footer-accordion.js");
/* harmony import */ var _modules_footer_accordion__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_footer_accordion__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _modules_modal_focus_trap__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/modal-focus-trap */ "./js/modules/modal-focus-trap.js");
/* harmony import */ var _modules_about_company_text_content__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/about-company-text-content */ "./js/modules/about-company-text-content.js");
/* harmony import */ var _modules_about_company_text_content__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_about_company_text_content__WEBPACK_IMPORTED_MODULE_8__);
...
/***/ "./js/modules/about-company-text-content.js":
/*!**************************************************!*\
  !*** ./js/modules/about-company-text-content.js ***!
  \**************************************************/
/*! no static exports found */
...
var paragraphs = document.querySelectorAll('.company-info__description-paragraph');
if (paragraphs) {
  var checkMediaQueryParagraphs = function checkMediaQueryParagraphs() {
...
/***/ "./js/modules/consult-button-content.js":
/*!**********************************************!*\
  !*** ./js/modules/consult-button-content.js ***!
  \**********************************************/
/*! no static exports found */
...
var consultButton = document.querySelector('.main-block__consult-button');
if (consultButton) {
...
var accordion = document.querySelectorAll('.main-footer__accordion');
var panels = document.querySelectorAll('.main-footer__links-list');
if (accordion && panels) {
  var handelClick = function handelClick(evt) {
...
/***/ "./js/modules/goods-services-subtitle-content.js":
/*!*******************************************************!*\
  !*** ./js/modules/goods-services-subtitle-content.js ***!
  \*******************************************************/
/*! no static exports found */
...
var subtitle = document.querySelector('.goods-services__subtitle');
var cardSubtitle = document.querySelector('.goods-services__card-subtitle--second');
...
/***/ "./js/modules/modal-focus-trap.js":
/*!****************************************!*\
  !*** ./js/modules/modal-focus-trap.js ***!
  \****************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var focus_trap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! focus-trap-js */ "../node_modules/focus-trap-js/src/index.js");
/* harmony import */ var focus_trap_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(focus_trap_js__WEBPACK_IMPORTED_MODULE_0__);

var modalWindow = document.querySelector('.main-modal');
document.addEventListener('keydown', function (evt) {
  focus_trap_js__WEBPACK_IMPORTED_MODULE_0___default()(evt, modalWindow);
});

/***/ }),

/***/ "./js/modules/modal-open-close.js":
/*!****************************************!*\
  !*** ./js/modules/modal-open-close.js ***!
  \****************************************/
/*! no static exports found */
...
var modalOpenButton = document.querySelector('.main-header__call-button');
var modalWindow = document.querySelector('.main-modal__container');
var modalCloseButton = document.querySelector('.main-modal__close-button');
var nameField = document.querySelector('#modal-name-field');
var body = document.querySelector('body');
var mainModal = document.querySelector('.main-modal');
var isEscapeKey = function isEscapeKey(evt) {
  return evt.key === 'Escape';
};
var setCloseModal = function setCloseModal() {
  modalWindow.classList.add('main-modal__container--closed');
  body.classList.remove('main-modal--open');
};
var setOpenModal = function setOpenModal() {
...
if (modalOpenButton && modalWindow && modalCloseButton && nameField) {
  var onModalEscButtonKeydown = function onModalEscButtonKeydown(evt) {
    if (isEscapeKey(evt)) {
      evt.preventDefault();
      setCloseModal();
    }
  ...
  mainModal.addEventListener('transitionend', function () {
    nameField.focus();
  });
}
...
var anchor = document.querySelector('#feedback-section');
var consultButton = document.querySelector('.main-block__consult-button');
if (anchor && consultButton) {
  var setSmoothScroll = function setSmoothScroll() {
...
var toggleButton = document.querySelector('.company-info__toggle-button');
var infoItems = document.querySelectorAll('.company-info__description-item');
